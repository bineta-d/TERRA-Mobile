  ...
  return (
    ...
    {/* <Stack.Screen
      ...
      <View className="top-bar d-flex flex-row justify-between px-5 mt-2 ">
        ...
        <Ionicons name='map-outline' size={20} onPress={() => router.push('FullMap')}></Ionicons>
      </View>
      ...
      <View className="items-center mt-4">
        <View className='search-bar border flex-row items-center p-3 w-[93%] bg-tan-pastel rounded-xl '>
          ...
          <TextInput className="px-3" value={search} placeholder='Neighborhood, Feature...' numberOfLines={5}/>
        </View>
      </View>
